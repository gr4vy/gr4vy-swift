...
final class Gr4vyPaymentOptionsServiceTests: XCTestCase {
    ...
    func testListPaymentOptionsAsyncSuccess() async throws {
        ...
        XCTAssertEqual(result[0].canStorePaymentMethod, true)
        XCTAssertEqual(result[0].canDelayCapture, false)
        ...
        XCTAssertEqual(result[1].canStorePaymentMethod, false)
        XCTAssertEqual(result[1].canDelayCapture, true)
